...
const INSTRUMENTS = [
  ...
  { symbol: 'SI=F', label: 'Silver Futures (SI)' },
  { symbol: 'NG=F', label: 'Natural Gas Futures (NG)' },
  { symbol: 'RTY=F', label: 'Russell 2000 Futures (RTY)' },
  { symbol: 'HG=F', label: 'Copper Futures (HG)' },
  { symbol: 'PL=F', label: 'Platinum Futures (PL)' },
  { symbol: '6E=F', label: 'Euro FX Futures (6E)' },
  { symbol: '6B=F', label: 'British Pound Futures (6B)' },
  { symbol: 'ZN=F', label: '10-Year T-Note Futures (ZN)' },
  { symbol: 'ZC=F', label: 'Corn Futures' },
  { symbol: 'ZW=F', label: 'Wheat Futures' },
  { symbol: 'ZS=F', label: 'Soybean Futures' },
  { symbol: 'ZM=F', label: 'Soybean Meal Futures' },
  { symbol: 'ZL=F', label: 'Soybean Oil Futures' },
  { symbol: 'KC=F', label: 'Coffee Futures' },
  { symbol: 'CC=F', label: 'Cocoa Futures' },
  { symbol: 'CT=F', label: 'Cotton Futures' },
  { symbol: 'SB=F', label: 'Sugar Futures' },
  { symbol: 'LE=F', label: 'Live Cattle Futures' },
  { symbol: 'HE=F', label: 'Lean Hogs Futures' },
  { symbol: 'OJ=F', label: 'Orange Juice Futures' },
  { symbol: '6J=F', label: 'Japanese Yen Futures' },
  { symbol: '6S=F', label: 'Swiss Franc Futures' },
  { symbol: '6A=F', label: 'Australian Dollar Futures' },
  { symbol: '6C=F', label: 'Canadian Dollar Futures' },
  { symbol: '6N=F', label: 'NZ Dollar Futures' },
  { symbol: 'ZT=F', label: '2-Year T-Note Futures' },
  { symbol: 'ZF=F', label: '5-Year T-Note Futures' },
  { symbol: 'ZB=F', label: '30-Year T-Bond Futures' },
  { symbol: 'UB=F', label: 'Ultra T-Bond Futures' },
  { symbol: 'HO=F', label: 'Heating Oil Futures' },
  { symbol: 'RB=F', label: 'RBOB Gasoline Futures' },
  { symbol: 'BZ=F', label: 'Brent Crude Futures' },
  { symbol: 'NKD=F', label: 'Nikkei 225 Futures' },
